...
public class Commons : MonoBehaviour
{
    ...
    public static double timeCountDownNextDay()
    {
        double _timeCountDown = 0;
        DateTime now = DateTime.Now;
        DateTime _time12h = new DateTime(now.Year, now.Month, now.Day, 23, 59, 59);
        _timeCountDown = Commons.ConvertToUnixTime(_time12h) - Commons.ConvertToUnixTime(now);
    ...
    public static IEnumerator CurrencyChange(TextMeshProUGUI textToDisplay, double orgNum, double desNum, float timePlay, bool DisplayZero)
    {
