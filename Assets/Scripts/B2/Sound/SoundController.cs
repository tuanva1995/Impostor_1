...
public class SoundController : MonoBehaviour
{
    ...
    public AudioClip cutVertical; // chém dọc
    public AudioClip cutHorizontal; // chém ngang
    public AudioClip knockDown; // đập xuống
    public AudioClip bite; // cắn
    public AudioClip broken; // đồ bị vỡ
